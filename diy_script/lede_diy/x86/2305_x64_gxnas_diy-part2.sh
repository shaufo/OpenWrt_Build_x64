...
sed -i "/uci commit system/i\uci set system.@system[0].hostname='Pangluyou'" package/lean/default-settings/files/zzz-default-settings
sed -i "s/hostname='.*'/hostname='Pangluyou'/g" ./package/base-files/files/bin/config_generate
